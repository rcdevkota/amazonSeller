        ...
        with psycopg2.connect(
            ...
            with conn.cursor() as c:
                ...
                for category in categories:
                    c.execute("INSERT INTO \"amazonSeller_category\" (name, link, country_id) VALUES (%s, %s, %s)", (category['name'], category['url'], '1'))
    ...
    try:
        ...
        with psycopg2.connect(
            ...
            with conn.cursor() as c:
                for category in categories:
                    print(category['name'])
                    c.execute("INSERT INTO \"amazonSeller_subcategory\" (name, link, category_id, country_id) VALUES (%s, %s, %s, %s)", (category['name'], category['url'], '32', '1'))
